...
// NewGetFactOutput creates a new instance of GetFactOutput
func NewGetFactOutput(details *ResultDetails, data json.RawMessage) (*GetFactOutput, error) {
...
// NewGetFactResult creates a new instance of GetFactResult
func NewGetFactResult(ddl *agent.DDL) *GetFactResult {
	return &GetFactResult{ddl: ddl}
}
...
func (d *GetFactResult) RecordResult(output *GetFactOutput, reply *replyfmt.RPCReply) {
	d.mu.Lock()
	defer d.mu.Unlock()
...
func (d *GetFactRequester) Do(ctx context.Context) (*GetFactResult, error) {
	dres := NewGetFactResult(d.r.client.ddl)
	...
	handler := func(pr protocol.Reply, r *rpcclient.RPCReply) {
		...
		output, err := NewGetFactOutput(NewResultDetails(pr.SenderID(), int(r.Statuscode), r.Statusmsg, pr.Time()), r.Data)
		if err != nil {
